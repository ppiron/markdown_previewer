...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this.defaultText = '# H1 element\n## H2 element\nLink: [Google](www.google.com)\n\nInline code: `<p>`\n\nBlock code: \n```\nconst a = x => x * x\n```\nList items:\n- First Item\n- Second Item\n\nBlockquote:\n> Example of blockquote.\n\nInline image: \n![alt text](https://github.com/adam-p/markdown-here/raw/master/src/common/images/icon48.png "Logo Title Text 1")\n\nBold **text** example.\n';
    _this.state = {
      text: _this.defaultText
    };

    _this.handleChange = _this.handleChange.bind(_this);
    _this.clearOnFirstFocus = _this.clearOnFirstFocus.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    key: 'clearOnFirstFocus',
    value: function clearOnFirstFocus() {
    ...
    value: function render() {
      var content = marked(this.state.text);
      console.log(content);
      return _react2.default.createElement(
        ...
        _react2.default.createElement('textarea', { onClick: this.clearOnFirstFocus, onChange: this.handleChange, id: 'editor', cols: '50', rows: '20', placeholder: 'write some text', value: this.state.text }),
        _react2.default.createElement('div', { id: 'preview', dangerouslySetInnerHTML: { __html: content } })
      );
    }
  }]);
